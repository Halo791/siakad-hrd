...
@php
    ...
    $tableTitles = [
        ...
        'riwayat-keuangan' => 'Riwayat Keuangan',
        'konsentrasi-peminatan' => 'Referensi Program Studi',
        'nilai-konversi' => 'Nilai Konversi MBKM',
        'aktivitas-prestasi' => 'Aktivitas dan Prestasi',
    ];
    $tabIcons = [
        'daftar-mahasiswa' => 'DM',
        'detail-mahasiswa' => 'DT',
            ...
            @else
                ...
                <div class="content-pad">
                    ...
                    @elseif($tab === 'riwayat-keuangan')
                        ...
                        <div class="grid grid-2">
                            <div>
                                ...
                                <div class="table-wrap" data-title="Daftar Tagihan"><table><thead><tr><th>Jenis</th><th>Nominal</th><th>Status</th></tr></thead><tbody>
                            ...
                            <div>
                                ...
                                <div class="table-wrap" data-title="Riwayat Pembayaran"><table><thead><tr><th>Metode</th><th>Nominal</th><th>Status</th></tr></thead><tbody>
                    ...
                    @elseif($tab === 'konsentrasi-peminatan')
                        ...
                        <div class="table-wrap" data-title="{{ $tableTitles[$tab] ?? $tabLabels[$tab] ?? 'Tabel Data' }}"><table><thead><tr><th>Kode</th><th>Program Studi</th><th>Fakultas</th></tr></thead><tbody>
                    ...
                    @elseif($tab === 'aktivitas-prestasi')
                        ...
                        <div class="table-wrap" data-title="Aktivitas MBKM"><table><thead><tr><th>Tipe</th><th>Mitra</th><th>Semester</th></tr></thead><tbody>
