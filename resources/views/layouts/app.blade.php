...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0;background:var(--soft);color:var(--ink);font-family:Inter,Arial,sans-serif}a{text-decoration:none;color:inherit}
        ...
        .table-wrap{overflow:auto;margin-top:12px;border:1px solid #cfcfcf;border-radius:4px;background:white;box-shadow:0 1px 2px rgba(15,23,42,.04)}.table-wrap[data-title]::before{content:attr(data-title);display:block;border-bottom:5px solid #f0d400;background:#171717;padding:10px 14px;color:white;font-size:13px;font-weight:900}.table-wrap[data-title]::after{content:"";display:block;clear:both}table{width:100%;border-collapse:collapse;background:white}th,td{border:1px solid #d7d7d7;padding:6px 7px;text-align:left;font-size:12px;line-height:1.35;vertical-align:top}th{background:#eeeeee;color:#111827;font-size:11px;font-weight:900;letter-spacing:0;text-transform:none}tbody tr:nth-child(even){background:#fafafa}tbody tr:hover{background:#f4fff1}.table-wrap td:first-child,.table-wrap th:first-child{text-align:center}.table-wrap input,.table-wrap select{min-width:96px;margin-top:0;border-radius:2px;padding:5px 7px;font-size:12px}.table-wrap .btn{border-radius:3px;padding:6px 9px;font-size:11px}.table-wrap .badge{border-radius:3px;padding:4px 7px;font-size:11px}.badge{display:inline-flex;border-radius:999px;background:#dcfce7;padding:5px 10px;color:#047857;font-size:12px;font-weight:900}.badge.gray{background:#f1f5f9;color:#475569}
        ...
        .alert{border-radius:10px;padding:12px 14px;margin-bottom:14px;font-weight:700}.ok{border:1px solid #86efac;background:#dcfce7;color:#166534}.err{border:1px solid #fecaca;background:#fee2e2;color:#991b1b}.pager{padding:14px}.pager svg{width:14px;height:14px}.siakad-pagination{display:flex;align-items:center;justify-content:space-between;gap:12px;border-top:1px solid #e5e7eb;background:#fbfbfb;color:#475569;font-size:12px;font-weight:800}.page-actions{display:flex;align-items:center;gap:8px}.page-btn,.page-current{display:inline-flex;align-items:center;justify-content:center;border:1px solid #cbd5e1;border-radius:4px;background:white;padding:7px 10px;color:#334155}.page-btn:hover{border-color:#42b429;color:#2f941d}.page-btn.disabled{background:#f1f5f9;color:#94a3b8;cursor:not-allowed}.page-current{border-color:#86efac;background:#ecfdf5;color:#166534}
